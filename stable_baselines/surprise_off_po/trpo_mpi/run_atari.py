...
from stable_baselines.surprise_off_po import TRPO_MPI
...
def train(env_id, num_timesteps, seed):
    ...
    model = TRPO_MPI(CnnPolicy, env, timesteps_per_batch=512, max_kl=0.001, cg_iters=10, cg_damping=1e-3, entcoeff=0.0,
