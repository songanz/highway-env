...
from stable_baselines.surprise.trpo_mpi.utils import traj_segment_generator, add_vtarg_and_adv, flatten_lists
from stable_baselines.surprise.net_CVAE import *
...
class TRPO_MPI(ActorCriticRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, timesteps_per_batch=256, max_kl=0.01, cg_iters=10, lam=0.98,
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            with self.sess.as_default():
                ...
                while True:
                    ...
                    ave_env_rewbuffer.extend(np.array(reward_buffer) / np.array(len_buffer))
