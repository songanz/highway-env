...
from stable_baselines.surprise.dqn.replay_buffer import ReplayBuffer, PrioritizedReplayBuffer
from stable_baselines.surprise.dqn.policies import DQNPolicy
from stable_baselines.surprise import dqn
