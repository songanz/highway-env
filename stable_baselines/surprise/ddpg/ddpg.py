...
from stable_baselines.surprise.dqn.replay_buffer import ReplayBuffer
from stable_baselines.surprise.ddpg.policies import DDPGPolicy
...
class DDPG(OffPolicyRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, memory_policy=None, eval_env=None, nb_train_steps=50,
                 ...
                 full_tensorboard_log=False, reset_env_step=200, surprise=False, CVAE_save_path=None):
